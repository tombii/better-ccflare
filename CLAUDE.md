...
This project is indexed by GitNexus as **better-ccflare** (7593 symbols, 17629 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
