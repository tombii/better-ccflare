...
This project is indexed by GitNexus as **better-ccflare** (8574 symbols, 15176 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
