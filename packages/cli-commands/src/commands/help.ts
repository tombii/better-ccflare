...
Commands:
  add <name> [--mode <claude-oauth|console|codex|qwen|xai|zai|minimax|anthropic-compatible|openai-compatible|nanogpt|kilo|openrouter|ollama|ollama-cloud|muse-spark>] [--priority <number>] [--modelMappings <JSON>]
    ...
    --mode: Account type (optional, will prompt if not provided)
      ...
      muse-spark: Muse Spark / Meta Model API provider (API key)
