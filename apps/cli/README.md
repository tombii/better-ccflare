...
- **🤖 Multi-Provider Support** - Claude OAuth, Claude API console, Vertex AI, AWS Bedrock, NanoGPT, z.ai, Minimax, Meta, OpenRouter, Kilo, Codex (OpenAI OAuth), xAI/Grok, Anthropic-compatible, and OpenAI-compatible providers
...
- **Extended Provider Support** - AWS Bedrock, NanoGPT (with dynamic pricing), Minimax, Meta, OpenRouter, Kilo, Codex (OpenAI OAuth), xAI/Grok, Anthropic-compatible, and OpenAI-compatible providers
...
- **z.ai, Minimax, Meta** - API key based providers with pay-as-you-go model
